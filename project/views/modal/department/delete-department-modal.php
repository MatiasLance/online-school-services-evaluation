      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-vibrant-golden-yellow btn-sm" data-bs-toggle="modal" data-bs-target="#departmentAskPasswordModal" data-bs-auto-close="false">Continue</button>
          </div>
        </div>
      </div>
    </div>