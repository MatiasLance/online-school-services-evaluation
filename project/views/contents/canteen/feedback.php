        ...
        <div class="col-12">
            <div class="card fade-in">
                <div class="card-header bg-custom-blue text-center py-4">
                    <h5 class="card-title mb-0">Canteen Service Feedback</h5>
                </div>
            </div>
            ...
            <div class="d-flex flex-row-reverse mt-4 gap-4">
                <button 
                    type="button" 
                    class="btn bg-custom-blue btn-sm d-flex align-items-center gap-2" id="listAllCanteenFeedbacks"
                    data-bs-toggle="modal" data-bs-target="#canteenViewFeedbacksModal"
                >
                ...
                <button 
                    ...
                    id="refreshCanteenServiceEvaluationResult"
                >
...
<?php include __DIR__ . '/../../modal/feedback/CanteenViewFeedbacksModal.php'; ?>
