        ...
        <div class="col-12 mb-4">
            <div class="card fade-in">
                <div class="card-header bg-custom-blue text-center py-4">
                    <h5 class="card-title mb-0">Finance Service Feedback</h5>
                </div>
            </div>
            ...
            <div class="d-flex flex-row-reverse mt-4 gap-4">
                <button 
                    type="button" 
                    class="btn bg-custom-blue btn-sm d-flex align-items-center gap-2" id="listAllFinanceFeedbacks"
                    data-bs-toggle="modal" data-bs-target="#financeViewFeedbacksModal"
                >
...
<?php include __DIR__ . '/../../modal/feedback/FinanceViewFeedbacksModal.php'; ?>
