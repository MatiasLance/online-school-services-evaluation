...
<div class="d-flex flex-column flex-md-row justify-content-between mt-5">
    <div class="input-group mb-3 w-25">
        <input type="text" class="form-control" id="filterByUserNameFormControlInput1" placeholder="Search User Account" aria-label="Search Admin Account" aria-describedby="basic-addon3">
