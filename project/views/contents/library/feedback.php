      ...
      <div class="row">
        <div class="col-12 mb-4">
            ...
            <div class="d-flex flex-row-reverse mt-4 gap-4">
                <button 
                    type="button" 
                    class="btn bg-custom-blue btn-sm d-flex align-items-center gap-2" id="listAllLibraryFeedbacks"
                    data-bs-toggle="modal" data-bs-target="#libraryViewFeedbacksModal"
                >
...
<?php include __DIR__ . '/../../modal/feedback/LibraryViewFeedbacksModal.php'; ?>
