const counter = jQuery('#studentActivityServiceAnswerCounter');
...
function loadAllResponses() {
    jQuery.ajax({
        url: 'https://script.google.com/macros/s/AKfycbwXLeA1aTEmVtTGCid6sUszwiG_2J_fHVexgQAfjJNVwON8lARzjaqM69obCAgvq2DaOA/exec',
        dataType: 'jsonp',
        beforeSend: function() {
            body.empty();
